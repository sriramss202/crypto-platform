  ...
  return (
    <>
      ...
      <div className="shrink-0 space-y-4 border-t border-white/10 p-5 md:p-6">
        ...
        <div className="rounded-2xl bg-white/5 p-4 backdrop-blur-md md:p-5"><p className="text-base font-semibold text-white">Admin session</p><p className="mt-2 text-xs text-gray-400 md:text-sm">Frontend preview mode</p></div>
      </div>
    </>
  );
}
